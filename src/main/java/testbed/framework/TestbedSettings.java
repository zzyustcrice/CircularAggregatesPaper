...
public class TestbedSettings {
  ...
  private void populateDefaultSettings() {
    if (Global.GUI) {
      addSetting(new TestbedSetting(Hz, SettingType.ENGINE, Global.Hz, 1, 100000));
      addSetting(new TestbedSetting(PositionIterations, SettingType.ENGINE, 10, 0, 100));
      addSetting(new TestbedSetting(VelocityIterations, SettingType.ENGINE, 10, 1, 100));
    } else {
      addSetting(new TestbedSetting(Hz, SettingType.ENGINE, Global.Hz, 1, 10000));
